...
export function ComponentConfigSchema() {
  return z
    .object({
      ...
      ThemeProvider: z
        .string()
        .default("@astrojs/starlight/components/ThemeProvider.astro"),
      ...
      SkipLink: z
        .string()
        .default("@astrojs/starlight/components/SkipLink.astro"),
      ...
      PageFrame: z
        .string()
        .default("@astrojs/starlight/components/PageFrame.astro"),
      /**
      ...
      MobileMenuToggle: z
        .string()
        .default("@astrojs/starlight/components/MobileMenuToggle.astro"),
      ...
      TwoColumnContent: z
        .string()
        .default("@astrojs/starlight/components/TwoColumnContent.astro"),
      ...
      SiteTitle: z
        .string()
        .default("@astrojs/starlight/components/SiteTitle.astro"),
      /**
      ...
      SocialIcons: z
        .string()
        .default("@astrojs/starlight/components/SocialIcons.astro"),
      /**
      ...
      ThemeSelect: z
        .string()
        .default("@astrojs/starlight/components/ThemeSelect.astro"),
      /**
      ...
      LanguageSelect: z
        .string()
        .default("@astrojs/starlight/components/LanguageSelect.astro"),
      ...
      Sidebar: z
        .string()
        .default("@astrojs/starlight/components/Sidebar.astro"),
      /**
      ...
      MobileMenuFooter: z
        .string()
        .default("@astrojs/starlight/components/MobileMenuFooter.astro"),
      ...
      PageSidebar: z
        .string()
        .default("@astrojs/starlight/components/PageSidebar.astro"),
      /**
      ...
      TableOfContents: z
        .string()
        .default("@astrojs/starlight/components/TableOfContents.astro"),
      /**
      ...
      ContentPanel: z
        .string()
        .default("@astrojs/starlight/components/ContentPanel.astro"),
      ...
      PageTitle: z
        .string()
        .default("@astrojs/starlight/components/PageTitle.astro"),
      ...
      MarkdownContent: z
        .string()
        .default("@astrojs/starlight/components/MarkdownContent.astro"),
      ...
      LastUpdated: z
        .string()
        .default("@astrojs/starlight/components/LastUpdated.astro"),
      /**
      ...
      Pagination: z
        .string()
        .default("@astrojs/starlight/components/Pagination.astro"),
      /**
      ...
      EditLink: z
        .string()
        .default("@astrojs/starlight/components/EditLink.astro"),
    })
    .default({});
}
